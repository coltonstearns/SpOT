...
def depth_to_points(depth, trunc_pixel, feat=None):
...
def depth_to_lidar_points(depth, trunc_pixel, P2, r_rect, velo2cam, feat_img=None):
    ...
    """
    pts = depth_to_points(depth, trunc_pixel, feat_img)
...
def iou_jit(boxes, query_boxes, mode='iou', eps=0.0):
    ...
    box_overlaps function in mmdet3d.ops.evaluation.
