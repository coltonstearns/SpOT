...
class SceneTracking:
    ...
    def eval_sample(self, sample_idx, sample_token, thread, last_sample=False):
        ...
        st_detections, instance_ids = self.track_manager.associate(detections, visualize=sample_idx==20 and (self.scene_idx % 25)==0, sample_id=sample_token)
        ...
        if perform_refinement:
            st_detections.enhanced_objects, runtime = self._process_st_detections(st_detections.enhanced_objects, visualize=sample_idx==20 and (self.scene_idx % 25)==0)
        ...
        # viz_st_detections(st_detections, sample_timestep, self.track_trajectory_params)
