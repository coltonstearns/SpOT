...
from spot.models.transformer.helpers import (ACTIVATION_DICT, NORM_DICT, WEIGHT_INIT_DICT,
                                             get_clones)
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward_pre(self, src,
        ...
        src2 = self.norm1(src)  # layer-norm is only applied on last dimension --> mask doesn't matter!
        value = src2
