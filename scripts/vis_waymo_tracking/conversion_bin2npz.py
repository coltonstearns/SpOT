...
parser.add_argument('--out_folder', type=str,
                    default='/mnt/truenas/scratch/ziqi.pang/datasets/waymo/sot/detection/gt/validation/')
parser.add_argument('--file_path', type=str,
                    default='/mnt/truenas/scratch/ziqi.pang/datasets/waymo/mot/info/validation_gt.bin')
